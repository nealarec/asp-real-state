...
public class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        // Configure MongoDB
        builder.Services.Configure<Model.Settings.MongoDBSettings>(
        ...
        if (useAzureBlob)
        {
            ...
            builder.Services.Configure<Model.Settings.AzureBlobSettings>(
        ...
        else
        {
            ...
            builder.Services.Configure<Model.Settings.S3Settings>(
    ...
    public static void ConfigureMiddleware(WebApplication app)
    {
        ...
        // This is here for being able to serve the UI from same machine of backend.
